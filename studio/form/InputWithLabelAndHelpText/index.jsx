...
const stories = theme =>
  storiesOf("Form", module).add("Input with label and help text", () => (
    <React.Fragment>
      <Label forInput="username" theme={theme}>
        Nombre de usuario
      </Label>
      <Input
        type="text"
      ...
      <Label forInput="password" theme={theme}>
        Nombre de usuario
      </Label>
      <Input
        type="password"
      ...
      <Label forInput="email" theme={theme}>
        Correo electrónico
      </Label>
      <Input
        type="text"
